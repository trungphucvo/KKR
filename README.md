...
NOMAD parser plugin for PySCF simulations output
...
```sh
git clone https://github.com/foo/nomad-parser-pyscf.git
cd nomad-parser-pyscf
...
| Name | E-mail     |
|------|------------|
| trungphuc vo | [votrungphuc063@gmail.com](mailto:votrungphuc063@gmail.com)
